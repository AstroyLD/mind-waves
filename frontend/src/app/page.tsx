      ...
      <header className="sticky top-0 z-40 w-full bg-black/80 backdrop-blur-sm">
        <div className="max-w-7xl w-full mx-auto flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn?(
              <Button size="sm" onClick={logOut} className="rounded-sm cursor-pointer bg-primary text-white hover:bg-primary/90">
                Log out
              </Button>
            ):(
              <Link href="/login">
              <Button size="sm" className="rounded-sm cursor-pointer bg-primary text-white hover:bg-primary/90">
                Log in
              </Button>
            </Link>
            )}
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Meditate. <span className="text-primary">Achieve</span>. Earn.
                  </h1>
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Link href="/login">
                    <Button size="lg" className="rounded-sm gap-2 bg-primary text-white hover:bg-primary/90">
                      Start Your Journey
